...
function showScreen(which){
  ...
  if(which === "screenSpin") document.querySelector('.navBtn[data-nav="spin"]').classList.add("navBtn--active");
  if(which === "screenFilters") document.querySelector('.navBtn[data-nav="filters"]').classList.add("navBtn--active");
  if(which === "screenProfile") document.querySelector('.navBtn[data-nav="profile"]').classList.add("navBtn--active");
...
function setActivity(a){
  ...
  $("activityTitle").textContent = (a.title || "Untitled").toString().toUpperCase();
  $("activityDesc").textContent = a.description || "";
  $("activityLane").textContent = (a.lane || (a.is_civic ? "COMMUNITY" : "A GENTLE SPARK")).toString().toUpperCase();
  ...
  $("activityMeta").textContent = `${time} • ${loc} • ${eff} • ${part}`;

  // progress mirrors
  $("progressTitle").textContent = $("activityTitle").textContent;
  $("progressDesc").textContent = a.description || "";
  $("progressLane").textContent = "IN PROGRESS";
  $("progressMeta").textContent = $("activityMeta").textContent;
}
